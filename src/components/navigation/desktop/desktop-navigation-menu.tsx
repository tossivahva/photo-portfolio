...
const DesktopNavigationMenu = () => {
    return (
        <NavigationMenu.Root className='relative z-[1] flex w-screen justify-center'>
            <NavigationMenu.List className='center m-0 flex list-none rounded-full bg-black/60 backdrop-blur-2xl border border-white/10 p-2'>
                <NavigationMenu.Item>
                    ...
                    <NavigationMenu.Content className='absolute top-0 left-0 w-full sm:w-auto'>
                        <ul className='m-0 list-none gap-x-[10px] py-3 px-2 sm:w-[200px] sm:grid-flow-col'>
            ...
            <div className='perspective-[2000px] absolute top-full left-0 flex w-[200px] translate-x-[calc(50%+100px)] justify-center'>
